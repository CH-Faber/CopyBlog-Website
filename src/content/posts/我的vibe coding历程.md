...
description: 回顾了从中学接触编程到大学期间探索Vibe Coding的历程，包括信息学竞赛的挫折、高中校园网站项目、AI夏令营与实习、接单独立开发以及线上实习的挑战与教训。通过这些经历反思了技术工具与个人成长的关系，并提出了在后AI时代应转变角色为产品经理的观点。
tags:
    - Vibe Coding
    - 个人经历
    - 大学生实习
...
# 文章概要
---
我想，每个人对于创造的可能性都有种生物学本能的热爱吧。而我目前的主要创造形式是游戏以及vibe coding，不过本文主要讲述的对象是vibe coding。写本文的目的是为了让本人理解自己所做的这些选择，尝试去回忆起自己所做之事，并且重新去审视自上大学以来的学业与工作之间的取舍。更重要的是，让未来的自己或者说在看着我文章此时此刻的你们，可以理解现在的Faber是一个怎么样的人。
...
自己做好了agent，PM让你去嵌入到产品中开发，替换掉旧有的自定义指标AI，按照正常的思路，肯定是使用旧有的鉴权路径以及以前的的对话数据库。毕竟自己还是实习生吗，不敢做出大的更改。但是由于使用的是高度集成的开源项目opencode，导致了很难使用旧的对话数据库，便和我的上司说看可能不太方便直接使用数据库，需要后期再考虑迁移。惯性思维，那肯定鉴权也是要看看是否可以使用旧有的路径，于是我一路询问相关的情况，并且一遍一遍地申请相关的权限，到最后发现其实一开始所选择的路径就走错了。

后来好不容易实现了，我向我的上司询问我该怎么操作，他说我要把我的代码推送到gitlab后再合并到develop分支，让陆总review一下。好巧不巧的是，当时我的PM也是姓陆，于是就让我搞错了对象，直接把MR合并请求发给了PM，让她来review ，也是非常的搞笑好吧。然后不过后来有一个前辈提醒了一下我，才正确地把MR发送给我们的Reviewer。然后这个期间我的需求是没有正常被立项在我们的itask的，PM还给了我一个新的项目需求，我还以为是我这个AI agent嵌入的需求，然后自己就根据这个需求的内容进度填写了那个新的需求的Itask，结果就是完全填写错了，还以为自己把所有工作都干的太差不差的，其实完全没有开始。

由于完全没有对接用户系统的经验，我在这个工作中表现得十分差劲。不知道如何去获取用户的数据，不知道如何识别一个用户，在对话数据存储上所做的表现的极烂。后来产品和我说明，我填的Itask填错了，那个是两个需求，一个是将我的AI Agent嵌入到我们的产品中，另一个是将我们产品中的所有AI服务都积分化，使用一个统一的平台来管理所有的服务，并建立一个统一的收费标准。本来想着应该也不难实现，甚至和前辈通过视频已经把我们的框架构思好了，但是依旧是不知道如何去推进。

除此之外，还有一些琐碎的需求不断推送给我，让我实现。刚刚开学的时候我还在积极地上课以跟上进度，在课余的时间处理我的工作，但这就导致其实我根本没有一点时间冗余，基本没有时间去社交，甚至没有时间去复习已经今天已经学习的功课。准确说也不是时间吧，而是没有心力去做。上课听的一知半解，下了课还要赶紧回到寝室去把约定好的工作做了。到后来，我基本就不怎么听课了，上课了就赶紧把这节课程会讲到的部分都看一遍，然后就打开我的远程开始做AI reviewer，或者甚至直接就不听了，直接签完到就走或者让朋友帮忙签到。这导致我现在的学业压力极大。

四月末的时候，甚至连自习都成为了一种我消解压力的方式，感觉可以安安静静地一个人学习真的很幸福。我在一种极度自我怀疑的状态中度过了那一个月，不仅仅是在于工作上毫无进展，还有所有的课程都没有办法正常跟上。上思政类课程是能翘则翘；上科学类课程则是边听边干别的工作。此外，滑板社的社团工作也一直压得我喘不过气，可能是第一次作为一名社团负责人，没有办法很好地平衡好社团的工作还有自己的生活，几乎每天都逼着自己出门去滑板。到最后甚至开始觉得自己的这种爱好变得恶心起来了。

渐渐地，我从一开始的膜拜，到最后厌恶反感。我终于明白，我是时候去做决断了。我当然可以继续干，前提是我不考虑我的学业。于是乎，在期末月来临之际，我选择了和我的上司说明情况，将卡住我三个月的项目推给我的一个前辈，解决并上线了其他小的需求，然后就选择了保职。

虽然是保职，但是感觉我的工作大抵是已经没有了，在放暑假之后，我准备同步相关的一些修改的时候，发现自己邮箱对应的gitlab账户已经被收回了，已经询问，上司没有帮我恢复账号的意思，反而说明最近确实有在做精简（没有明说人员精简，但是说了组群以及相应的权限精简），然后让我把修改的代码直接发送给我的前辈同事。
# 感悟
---
由于这个工作的缘故，其实基本下半学期都是陷入了一种相对迷茫的时刻，感觉我逐渐迷失了感知真正想要的东西的能力。Vibe Coding对于我来说就是一个将自己内心想法或者他人的想法展现出来的工具，想要用好它，首先需要内心充盈，有能够和智能交流的能力。很多人刚刚接触到这些内容肯定觉得特别震撼，可以只用动动嘴皮子（或者手指头）就可以实现这么惊艳绝伦的内容；但很快，人们就会发现，这个工具确实很强悍，强悍到自己无法驾驭，无法使他真正为我们创造正向价值，更多的算是一种玩具。有人先接触的是国内或者早期的顶尖模型，它们虽然很适合入门，但是真正驾驭好这些模型往往需要各方面一定的素养；而后他们慢慢开始尝试接触顶模，发现基本不需要怎么动脑就好了，像吸了毒一样，开始寻找相关的账号，开始慢慢地投钱，愈试愈爽，渐渐地沉浸在顶模带来的震撼中。我承认，非计算机出身的人（包括我自己）确实可以创造有价值的内容，但是没有人会为了你理想主义的idea产品买单，即便是你用无数token堆出来的。就算有人买单，你真的可以覆盖掉你的token成本吗？

就算可以，非科班出身的你，有能力将变现这个过程可复现化吗？我的意思是，你真的可以在比打工赚的还少的时候静下心来踏踏实实在干中学，学中干，不断总结经验，不断突破学习不断进步吗？这其实相当的反直觉。因为就在你这块屏幕里面，你可以接触到世界上最聪明的编程模型，你恨不得直接让它来帮你完成所有的工作，为什么还要经过你？人类向来在偷懒这一方面是很有天赋的。当然我不是说偷懒不好，很多时候，就是因为人类想要偷懒，所以才会不断有新的工具诞生，这一点在人工智能时代依旧奏效。但是我们还是需要去学习怎么将你的工作流融入Vibe Coding中（此处的工作流为产品经理视角，例如接单，从确定用户的需求，到不断交流构建好整个框架，再到分批次交付流程，最后结单），这个是相当宝贵的能力。

在这个后AI时代，普通的编程工作，基本上完全被AI所取代。很多人在接触Vibe Coding之后角色并没有转变正确，逐渐称为了AI Reviewer，这是错误的。我们应该转变为PM，也就是产品经理。虽然这有一部分是我上司提出来的，但很多时候我个人确确实实也有这个体会。只有成为自己的PM，成为AI的PM，才能真正和AI产出一些有价值的内容。

愿各位都能使用Vibe Coding产出真正有价值的内容。
